...
Sí, usar un `<main>` y dentro un `<div>` para mostrar contenido dinámico es justo lo que se hace en sitios profesionales — es limpio, semántico y te deja jugar con animaciones o actualizaciones sin recargar la página.
...
agregue también un efecto tipo *“fade-in”*
o desplazamiento animado cuando aparezcan las tarjetas 
(para hacerlo más dinámico visualmente
